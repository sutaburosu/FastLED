// Unit tests for audio::detector::MusicalBeat - adversarial and boundary tests
// standalone test
...
FL_TEST_CASE("audio::detector::MusicalBeat - steady 120 BPM tight") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
    config.minBPM = 50.0f;
...
FL_TEST_CASE("audio::detector::MusicalBeat - random onset rejection tight") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
    config.minBPM = 50.0f;
    config.maxBPM = 250.0f;
...
FL_TEST_CASE("audio::detector::MusicalBeat - first beat always validates") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
    config.minBeatConfidence = 0.5f;
    config.sampleRate = 10000;
...
FL_TEST_CASE("audio::detector::MusicalBeat - tempo change detection") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
    config.minBPM = 50.0f;
    config.maxBPM = 250.0f;
...
FL_TEST_CASE("audio::detector::MusicalBeat - IBI ring buffer does not overflow") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
...
FL_TEST_CASE("audio::detector::MusicalBeat - high confidence for perfect tempo") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
...
FL_TEST_CASE("audio::detector::MusicalBeat - confidence gate blocks isBeat") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
...
FL_TEST_CASE("audio::detector::MusicalBeat - BPM range rejection") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
...
FL_TEST_CASE("audio::detector::MusicalBeat - IBI average tracking") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
    config.sampleRate = 10000;
    config.samplesPerFrame = 100;
...
// Keep: Reset
FL_TEST_CASE("audio::detector::MusicalBeat - reset clears state") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
    config.sampleRate = 10000;
    config.samplesPerFrame = 100;
...
FL_TEST_CASE("audio::detector::MusicalBeat - statistics consistency") {
    audio::detector::MusicalBeat detector;
    audio::detector::MusicalBeatDetectorConfig config;
    config.minBPM = 50.0f;
    config.maxBPM = 250.0f;
