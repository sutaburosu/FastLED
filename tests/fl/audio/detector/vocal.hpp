// Unit tests for audio::detector::Vocal
...
FL_TEST_CASE("audio::detector::Vocal - pure sine is not vocal") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);

    auto ctx = fl::make_shared<audio::Context>(makeSample_VocalDetector(440.0f, 1000));
...
FL_TEST_CASE("audio::detector::Vocal - confidence in valid range") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - reset clears state") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - callbacks don't crash") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - needsFFT is true") {
    audio::detector::Vocal detector;
    FL_CHECK(detector.needsFFT());
}

FL_TEST_CASE("audio::detector::Vocal - getName returns correct name") {
    audio::detector::Vocal detector;
    FL_CHECK(fl::strcmp(detector.getName(), "Vocal") == 0);
}

FL_TEST_CASE("audio::detector::Vocal - onVocalStart and onVocalEnd callbacks") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
    ...
    for (int round = 0; round < 3; ++round) {
        ...
        auto silentCtx = fl::make_shared<audio::Context>(
            audio::Sample(silence, round * 1000 + 500));
...
FL_TEST_CASE("audio::detector::Vocal - amplitude sweep: spectral features stable across dB levels") {
...
FL_TEST_CASE("audio::detector::Vocal - amplitude sweep: confidence consistency for same signal") {
    float confidences[5] = {};
...
FL_TEST_CASE("audio::detector::Vocal - single sine 440Hz is not vocal") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - multi-harmonic is not vocal") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - vowel ah is vocal") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - vowel ee is vocal") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - chirp is not vocal") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - two unrelated sines not vocal") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
inline audio::Sample makeGuitarLike(fl::u32 timestamp, float amplitude = 16000.0f,
...
inline audio::Sample makeVoiceInMixLike(fl::u32 timestamp, float amplitude = 16000.0f,
                                       int count = 512, float sampleRate = 44100.0f) {
    fl::vector<fl::i16> data(count, 0);
    fl::fl_random rng(43);
...
FL_TEST_CASE("audio::detector::Vocal - guitar-like broadband not detected as vocal") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
    for (int frame = 0; frame < 5; ++frame) {
...
FL_TEST_CASE("audio::detector::Vocal - voice-in-mix harmonic structure") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
    for (int frame = 0; frame < 5; ++frame) {
...
FL_TEST_CASE("audio::detector::Vocal - jittered vowel has measurable envelope jitter") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - guitar string decay has low irregularity") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal - time-domain features print diagnostics") {
    // Diagnostic test: print all feature values for key signal types
    struct TestSignal {
        const char* name;
        audio::Sample (*gen)(fl::u32);
    };
...
inline audio::Sample makeVocalInFullMix(float vocalRatio, fl::u32 timestamp,
    ...
    return audio::Sample(mixed, timestamp);
}
...
FL_TEST_CASE("audio::detector::Vocal - isolated vocal vs vocal in full mix") {
    // 1. Isolated vocal — should be detected
    audio::detector::Vocal isoDetector;
    ...
    audio::detector::Vocal mixDetector;
    ...
    audio::detector::Vocal backingDetector;
...
FL_TEST_CASE("audio::detector::Vocal - drums+bass backing track not vocal") {
    audio::detector::Vocal detector;
    detector.setSampleRate(44100);
...
inline FeatureSnapshot runSignal(audio::Sample (*gen)(fl::u32), int frames = 15) {
    audio::detector::Vocal det;
    det.setSampleRate(44100);
...
FL_TEST_CASE("audio::detector::Vocal stability - vowel feature golden ranges") {
...
FL_TEST_CASE("audio::detector::Vocal stability - pure sine feature golden ranges") {
...
FL_TEST_CASE("audio::detector::Vocal stability - guitar string feature golden ranges") {
    auto genGuitar = [](fl::u32 ts) {
        return makeGuitarStringDecay(220.0f, ts);
    };
...
FL_TEST_CASE("audio::detector::Vocal stability - white noise feature golden ranges") {
...
FL_TEST_CASE("audio::detector::Vocal stability - feature ordering: vowel vs sine") {
...
FL_TEST_CASE("audio::detector::Vocal stability - feature ordering: vowel vs guitar") {
    auto vowel = test_vocal::runSignal([](fl::u32 ts) {
        return makeSyntheticVowel(150.0f, 700.0f, 1200.0f, ts);
    });
...
FL_TEST_CASE("audio::detector::Vocal stability - feature ordering: vowel vs noise") {
    auto vowel = test_vocal::runSignal([](fl::u32 ts) {
        return makeSyntheticVowel(150.0f, 700.0f, 1200.0f, ts);
    });
...
FL_TEST_CASE("audio::detector::Vocal stability - separation: isolated vocal vs backing") {
...
FL_TEST_CASE("audio::detector::Vocal stability - separation: vocal-in-mix vs backing") {
...
FL_TEST_CASE("audio::detector::Vocal stability - separation: formant discriminates vocal vs guitar-like") {
    auto vowel = test_vocal::runSignal([](fl::u32 ts) {
        return makeSyntheticVowel(150.0f, 700.0f, 1200.0f, ts);
    });
    auto guitar = test_vocal::runSignal([](fl::u32 ts) {
...
FL_TEST_CASE("audio::detector::Vocal stability - vocal flatness stable across mix ratios") {
...
FL_TEST_CASE("audio::detector::Vocal weight-lock - full-band feature diagnostic") {
...
FL_TEST_CASE("audio::detector::Vocal weight-lock - full-band backing not vocal") {
...
FL_TEST_CASE("audio::detector::Vocal weight-lock - full-band formant gap locks weights") {
    auto backing = test_vocal::runFullBandMix(0.0f, 20);
...
FL_TEST_CASE("audio::detector::Vocal weight-lock - full-band vocal-in-mix separation") {
    auto backing = test_vocal::runFullBandMix(0.0f, 20);
    auto vocal = test_vocal::runFullBandMix(1.0f, 20);
...
FL_TEST_CASE("audio::detector::Vocal weight-lock - full-band confidence monotonic with vocal level") {
...
FL_TEST_CASE("audio::detector::Vocal weight-lock - acoustic guitar body resonances") {
...
FL_TEST_CASE("audio::detector::Vocal degenerate - confidence always in [0, 1]") {
...
FL_TEST_CASE("audio::detector::Vocal degenerate - all boosts simultaneous still clamped") {
...
FL_TEST_CASE("audio::detector::Vocal degenerate - sawtooth wave not vocal") {
    audio::detector::Vocal det;
    det.setSampleRate(44100);
    for (int frame = 0; frame < 10; ++frame) {
...
FL_TEST_CASE("audio::detector::Vocal degenerate - AM tremolo tone not vocal") {
    audio::detector::Vocal det;
    det.setSampleRate(44100);
    for (int frame = 0; frame < 15; ++frame) {
...
FL_TEST_CASE("audio::detector::Vocal degenerate - pitched tom not vocal") {
    audio::detector::Vocal det;
    det.setSampleRate(44100);
    for (int frame = 0; frame < 10; ++frame) {
...
FL_TEST_CASE("audio::detector::Vocal degenerate - speech-band noise not vocal") {
    audio::detector::Vocal det;
    det.setSampleRate(44100);
    for (int frame = 0; frame < 10; ++frame) {
...
FL_TEST_CASE("audio::detector::Vocal degenerate - formant gap >= 0.35") {
    auto vowel = test_vocal::runSignal([](fl::u32 ts) {
        return makeSyntheticVowel(150.0f, 700.0f, 1200.0f, ts);
    });
    auto guitar = test_vocal::runSignal([](fl::u32 ts) {
...
FL_TEST_CASE("audio::detector::Vocal degenerate - full-band variance separation >= 0.05") {
    auto vocal = test_vocal::runFullBandMix(1.0f, 20);
    auto backing = test_vocal::runFullBandMix(0.0f, 20);
