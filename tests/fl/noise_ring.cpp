...
// Includes noise ring, sphere, and cylinder tests (cylinder merged from noise_cylinder.cpp)
#if 0

FL_TEST_CASE("[.]noiseRingHSV8 temporal smoothness - small time delta") {
...
FL_TEST_CASE("[.]noiseRingHSV8 temporal evolution - large time delta") {
    const int NUM_LEDS = 128;
    const float ANGLE_STEP = 2.0f * M_PI / NUM_LEDS;
...
FL_TEST_CASE("[.]noiseRingHSV8 temporal response ratio") {
    const int NUM_LEDS = 128;
    const float ANGLE_STEP = 2.0f * M_PI / NUM_LEDS;
...
FL_TEST_CASE("[.]noiseRingCRGB temporal test") {
    const int NUM_LEDS = 128;
    const float ANGLE_STEP = 2.0f * M_PI / NUM_LEDS;
...
FL_TEST_CASE("[.]noiseRingHSV16 full ring coverage") {
...
FL_TEST_CASE("[.]noiseRingHSV8 radius level of detail") {
...
// Sphere noise tests
FL_TEST_CASE("[.]noiseSphereHSV8 temporal smoothness - small time delta") {
...
FL_TEST_CASE("[.]noiseSphereHSV8 temporal evolution - large time delta") {
    const int NUM_SAMPLES = 128;
    const float ANGLE_STEP = 2.0f * M_PI / NUM_SAMPLES;
...
FL_TEST_CASE("[.]noiseSphereHSV8 temporal response ratio") {
    const int NUM_SAMPLES = 128;
    const float ANGLE_STEP = 2.0f * M_PI / NUM_SAMPLES;
...
FL_TEST_CASE("[.]noiseSphereCRGB temporal test") {
    const int NUM_SAMPLES = 128;
    const float ANGLE_STEP = 2.0f * M_PI / NUM_SAMPLES;
...
FL_TEST_CASE("[.]noiseSphereHSV16 full sphere coverage") {
...
FL_TEST_CASE("[.]noiseSphereHSV8 radius level of detail") {
...
FL_TEST_CASE("[.]noiseSphereHSV8 polar angle variation") {
...
FL_TEST_CASE("[.]noiseRingHSV16 stress test - 1M time samples") {
...
FL_TEST_CASE("[.]noiseRingHSV16 angle sweep - full ring coverage at fixed time") {
...
FL_TEST_CASE("[.]noiseRingHSV16 2D parameter space - time + angle variation") {
...
FL_TEST_CASE("[.]noiseRingHSV16 random angle + time - 1M samples") {
...
FL_TEST_CASE("[.]noiseRingHSV16 find optimal extents for 98% coverage - 100k raw samples") {
...
FL_TEST_CASE("[.]noiseRingHSV16 extent validation - 10k random samples at radius 1000") {
...
// ============================================================
// Noise cylinder tests (merged from noise_cylinder.cpp)
// ============================================================
