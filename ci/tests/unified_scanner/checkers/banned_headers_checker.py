...
class BannedHeadersChecker(BaseChecker):
    ...
    HEADER_RECOMMENDATIONS: dict[str, str] = {
        ...
        "iostream": "fl/str.h or fl/stl/strstream.h",
        ...
        "map": "fl/stl/map.h (check fl/stl/unordered_map.h for hash-based)",
        "set": "fl/stl/set.h",
        ...
        "chrono": "fl/stl/chrono.h",
        "fstream": "fl/stl/fstream.h or platform file operations",
        "sstream": "fl/stl/sstream.h",
        "iomanip": "fl/stl/iostream.h stream manipulators",
        "exception": "Use error codes or fl/stl/expected.h if available",
        "stdexcept": "Use error codes instead",
        "typeinfo": "Use fl/stl/type_traits.h or RTTI if unavoidable",
        "ctime": "fl/stl/chrono.h",
        "cmath": "fl/stl/math.h",
        "math.h": "fl/stl/math.h",
