...
class s8x24 {
  public:
    ...
    static FASTLED_FORCE_INLINE int sign(s8x24 x) {
    ...
    FASTLED_FORCE_INLINE s8x24 floor() const {
        return floor(*this);
    }

    FASTLED_FORCE_INLINE s8x24 ceil() const {
        return ceil(*this);
    }

    FASTLED_FORCE_INLINE s8x24 fract() const {
        return fract(*this);
    }

    FASTLED_FORCE_INLINE s8x24 abs() const {
        return abs(*this);
    }
