...
// ============================================================================
// Fixed-Point Implementation of Module_Experiment3
// ============================================================================

void Module_Experiment3_FP::draw(Context &ctx) {
    using FP = fl::s16x16;
    ...
    // dist = distance[x][y] - (12 + directional[3] * 4)
    const fl::i32 dist_offset_raw = FP(12.0f + e->move.directional[3] * 4.0f).raw();
