...
struct AnimartrixEntry {
    ...
    AnimartrixEntry(AnimartrixAnim a, const char *n, void (FastLEDANIMartRIX::*f)())
        : anim(a), name(n), func(f) {}
};
...
static const AnimartrixEntry ANIMATION_TABLE[] = {
    ...
    {CALEIDO1, "CALEIDO1", &FastLEDANIMartRIX::Caleido3},
    ...
    {MODULE_EXPERIMENT_SM1, "MODULE_EXPERIMENT_SM1", &FastLEDANIMartRIX::SpiralMatrix1},
    {MODULE_EXPERIMENT_SM2, "MODULE_EXPERIMENT_SM2", &FastLEDANIMartRIX::SpiralMatrix2},
    {MODULE_EXPERIMENT_SM3, "MODULE_EXPERIMENT_SM3", &FastLEDANIMartRIX::SpiralMatrix3},
    {MODULE_EXPERIMENT_SM4, "MODULE_EXPERIMENT_SM4", &FastLEDANIMartRIX::SpiralMatrix4},
    {MODULE_EXPERIMENT_SM5, "MODULE_EXPERIMENT_SM5", &FastLEDANIMartRIX::SpiralMatrix5},
    {MODULE_EXPERIMENT_SM6, "MODULE_EXPERIMENT_SM6", &FastLEDANIMartRIX::SpiralMatrix6},
    {MODULE_EXPERIMENT_SM8, "MODULE_EXPERIMENT_SM8", &FastLEDANIMartRIX::SpiralMatrix8},
    {MODULE_EXPERIMENT_SM9, "MODULE_EXPERIMENT_SM9", &FastLEDANIMartRIX::SpiralMatrix9},
    {MODULE_EXPERIMENT_SM10, "MODULE_EXPERIMENT_SM10",
     &FastLEDANIMartRIX::SpiralMatrix10},
