...
/// ## Usage Example
/// ```cpp
/// // ChannelEngineUART is automatically registered with ChannelManager
...
///
/// ## See Also
/// - Implementation: `channel_driver_uart.cpp`
...
private:
    ...
    /// @brief Scratch buffer for LED RGB data (owned by channel driver)
    fl::vector<u8> mScratchBuffer;

    /// @brief Encoded UART buffer for wave8 output (owned by channel driver)
