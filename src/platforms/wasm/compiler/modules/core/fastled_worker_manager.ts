...
import { FASTLED_DEBUG_LOG, FASTLED_DEBUG_ERROR, FASTLED_DEBUG_TRACE } from './fastled_debug_logger.ts';
import { fastLEDEvents } from './fastled_events.ts';
...
export class FastLEDWorkerManager {
  ...
  async createWorker(config) {
    ...
    try {
      ...
      // The new URL(..., import.meta.url) pattern must be inline in the
