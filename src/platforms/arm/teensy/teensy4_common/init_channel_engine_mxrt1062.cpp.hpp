...
/// @file init_channel_engine_mxrt1062.cpp.hpp
/// @brief Teensy 4.x-specific channel engine initialization
///
/// This file provides lazy initialization of Teensy 4.x-specific channel engines
...
static void addSpiHardwareIfPossible(ChannelBusManager& manager) {
    FL_DBG("Teensy 4.x: Registering unified HW SPI channel engine");
